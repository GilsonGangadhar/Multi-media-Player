...
export const getPopularVideos = () => async (dispatch, getState) => {
 ...
 export const getVideosByCategory = keyword => async (dispatch, getState) => {
    ...
    console.log("you are here in getVideosByCategory")
    try {
       dispatch({
          type: HOME_VIDEOS_REQUEST,
       })
